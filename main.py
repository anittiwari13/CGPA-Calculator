...
class Main(object):
    ...
    def __init__(self, root):
        ...
        self._labelframe_3 = tkinter.LabelFrame(root,background = "dark orange",font = "{Cambria} 10 bold",foreground = "black",text = "Student Details",)
        self._frame_1 = tkinter.Frame(root,background = "black",)
        self._frame_2 = tkinter.Frame(root,background = "black",)
        self._frame_3 = tkinter.Frame(root,background = "black",)
        self._frame_4 = tkinter.Frame(root,background = "black",)
        self._frame_5 = tkinter.Frame(root,background = "black",)
        self._frame_6 = tkinter.Frame(root,background = "black",)
        self._frame_7 = tkinter.Frame(root,background = "black",)
        self._frame_8 = tkinter.Frame(root,background = "black",)
        self._frame_9 = tkinter.Frame(root,background = "black",)
        self._frame_10 = tkinter.Frame(root,background = "black",)
        self._frame_11 = tkinter.Frame(root,background = "black",)
        self._frame_12 = tkinter.Frame(root,background = "black",)
        self._frame_13 = tkinter.Frame(root,background = "black",)
        self._frame_14 = tkinter.Frame(root,background = "black",)
        self._frame_15 = tkinter.Frame(root,background = "black",)
        self._frame_16 = tkinter.Frame(root,background = "black",)
        self._frame_17 = tkinter.Frame(root,background = "black",)
        self._frame_18 = tkinter.Frame(root,background = "black",)
        self._frame_20 = tkinter.Frame(root,background = "black",)
        self._frame_24 = tkinter.Frame(root,background = "black",)
        self._frame_22 = tkinter.Frame(root,background = "black",)
        self._frame_23 = tkinter.Frame(root,background = "black",)
        self._frame_25 = tkinter.Frame(root,background = "black",)
        self._frame_26 = tkinter.Frame(root,background = "black",)
        self._frame_27 = tkinter.Frame(root,background = "black",)
        self._frame_28 = tkinter.Frame(root,background = "black",)
        self._frame_29 = tkinter.Frame(root,background = "black",)
        self._frame_30 = tkinter.Frame(root,background = "black",)
        self._frame_32 = tkinter.Frame(root,background = "black",)
        self._frame_33 = tkinter.Frame(root,background = "black",)
        self._frame_34 = tkinter.Frame(root,background = "black",)
        self._frame_35 = tkinter.Frame(root,background = "black",)
        self._frame_42 = tkinter.Frame(root,background = "black",)
        self._frame_43 = tkinter.Frame(root,background = "black",)
        self._frame_44 = tkinter.Frame(root,background = "black",)
        self._frame_45 = tkinter.Frame(root,background = "black",)
        self._frame_46 = tkinter.Frame(root,background = "black",)
        self._label_1 = tkinter.Label(root,activebackground = "black",activeforeground = "#cccccc",background = "black",font = "{Cambria} 9 bold",
            foreground = "#cccccc",image = "Screenshot_(117).gif",justify = "right",text = "_label_1",)
        self._label_2 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",
...
Academic excellence is measured using the Grade Point Average (GPA) and Cumulative Grade Point Average (CGPA).
 ...
 to evaluate their academic performance from time to time and improve themselves by the remarks provided.   """,)
        self._label_3 = tkinter.Label(root,activebackground = "dark orange",background = "dark orange",font = "{Cambria} 12 bold",foreground="black",
        ...
        self._label_5 = tkinter.Label(self._labelframe_3,activebackground = "black",background = "dark orange",foreground="black",font = "{Cambria} 10 bold",text = "Name:",)
        self.name = tkinter.Entry(self._labelframe_3,width = 25)
        self._label_6 = tkinter.Label(self._labelframe_3,activebackground = "black",background = "dark orange",foreground="black",font = "{Cambria} 10 bold",
            text = "    Registration number :",)
        self.regno = tkinter.Entry(self._labelframe_3,width = 25,)
        self._label_10 = tkinter.Label(root,activebackground = "black",background = "black",image = "Screenshot_(119).gif",text = "_label_10",)
        self._label_12 = tkinter.Label(self._frame_1,activebackground = "black",activeforeground = "dark orange",background = "black",
            font = "{MS Sans Serif} 10 bold",foreground = "dark orange",text = " First Semester :",)
        self._label_13 = tkinter.Label(root,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Course Title",)
        self._label_14 = tkinter.Label(root,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Course Code",)
        self._label_16 = tkinter.Label(root,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Credit",)
        self._label_20 = tkinter.Label(root,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Grade Obtained",)
        ...
        self.firsttgpavalue = tkinter.Label(root,
            ...
            foreground = "white",
            text = 0.00,)
        self._label_22 = tkinter.Label(root,activebackground = "gray15",background = "gray15",foreground="orange red",font = "{Cambria} 8 bold",text = "Grade",)
        self._label_24 = tkinter.Label(root,activebackground = "gray15",background = "gray15",foreground="orange red",font = "{Cambria} 8 bold",text = "Grade Point",)
        self._label_25 = tkinter.Label(root,activebackground = "gray15",background = "gray15",foreground="orange red",font = "{Cambria} 8 bold",text = "O (Outstanding)",)
        ...
        self._label_47 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 10,)
        self._label_48 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "A+",)
        self._label_49 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 9,)
        self._label_50 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "A",)
        self._label_51 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 8,)
        self._label_52 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "B+",)
        self._label_53 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 7,)
        self._label_54 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "B",)
        self._label_55 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 6,)
        self._label_56 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "C+",)
        self._label_57 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 5,)
        self._label_58 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = "C",)
        self._label_59 = tkinter.Label(root,background = "gray15",font = "{Cambria} 8 bold",foreground="orange red",padx = 0,pady = 0,text = 4,)
        self._label_11 = tkinter.Label(self._frame_24,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Course Title",)
        self._label_15 = tkinter.Label(self._frame_24,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Course Code",)
        self._label_17 = tkinter.Label(self._frame_24,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Credit",)
        self._label_18 = tkinter.Label(self._frame_24,activebackground = "dark orange",background = "dark orange",foreground="black",font = "{Cambria} 8 bold",text = "Grade Obtained",)
        self._label_4 = tkinter.Label(root,activebackground = "#d2ffd2",background = "gray15",foreground="orange red",font = "{Cambria} 8 bold",padx = 0,pady = 0,text = "E (Reappear)",)
        ...
        self._label_31 = tkinter.Label(root,
            ...
            foreground = "white",
            text = "Developed with \u2764 by AKA		\u00A92020",
        )

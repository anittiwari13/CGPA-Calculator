...
class Newuser(object):
    ...
    def __init__(self, root):
        ...
        self._label_1 = tkinter.Label(root,
            ...
            image = "new_user.gif",
            text = "_label_1",)
        self._label_2 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 18 bold",takefocus = 1,text = "New User",)
        self._label_3 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",borderwidth = 0,font = "{Cambria} 8 bold",text = "Name",)
        self._label_4 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 8 bold",text = "User ID",)
        self.userid = tkinter.Entry(self._frame_2,background = "white",width = 50,)
        self.password = tkinter.Entry(self._frame_3,background = "white",width = 50,show="*")
        self._label_5 = tkinter.Label(root,
            activebackground = "black",
            activeforeground = "orange red",
            background = "gray17",
            font = "{Cambria} 10 bold",
            foreground = "orange red",
            text = "\u26A0\uFE0F   Provide correct details to create an account",)
        self._label_6 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 8 bold",text = "Password",)
        self.cpassword = tkinter.Entry(self._frame_4,width = 50,show="*")
        self._label_7 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 8 bold",text = "Confirm Password",)
        ...
        self.close = tkinter.Button(root,
            ...
            text = "Close",)
        self.name = tkinter.Entry(self._frame_1,background = "white",width = 50,)

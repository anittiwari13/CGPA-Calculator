...
class Login(object):
    ...
    def __init__(self, root):
        ...
        self._label_7 = tkinter.Label(root,
            ...
            text = "_label_7",)
        self._label_2 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 24 bold",text = "Login",)
        self._label_3 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 10 bold",text = " Username  ",)
        self._label_4 = tkinter.Label(root,activebackground = "black",background = "black",foreground="dark orange",font = "{Cambria} 11 bold",text = "Password",)
